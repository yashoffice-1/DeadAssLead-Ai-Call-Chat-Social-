    ...
    <>
      ...
      <div
        className={cn(
          ...
          // Desktop: relative side panel
          "md:relative md:inset-auto md:z-auto md:h-full md:w-[380px] md:shrink-0 md:border-l md:border-border"
        )}
      >
        ...
        <div className="flex shrink-0 items-center justify-between border-b border-border px-4 py-3">
          ...
          <button
            onClick={onClose}
            className="mr-2 flex size-8 items-center justify-center rounded-lg text-muted-foreground hover:bg-accent md:hidden"
            aria-label="Back"
          >
          ...
          <button
            onClick={onClose}
            className="ml-2 hidden shrink-0 rounded-md p-1.5 text-muted-foreground transition-colors hover:bg-accent hover:text-foreground md:flex"
        ...
        {/* Scrollable content — uses native overflow for reliable scrolling */}
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-2">
                {flow.rules.map((rule, i) => (
                  <div key={i} className="flex items-start gap-2 rounded-lg border border-border bg-accent/30 p-2.5">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-2.5">
                {toolToggles.map((tool) => (
                  <div key={tool.id} className="flex items-center justify-between rounded-lg border border-border p-2.5 transition-colors hover:bg-accent/30">
        ...
        {/* Footer Actions - shrink-0 to always stay visible */}
